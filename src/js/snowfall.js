...
var snowFall = (function () {
    function Snowfall() {
        ...
        function Flake(parent, size, speed) {
            ...
            this.lifeTime = 0;  // Nuevo contador de tiempo
            ...
            this.update = function () {
                this.y += this.speed;
                this.lifeTime++;  // Aumentamos el contador de tiempo
        
                if (this.y > height - (this.size + 6) || this.lifeTime > 300) {  // 300 es el tiempo máximo de vida antes de eliminarlo
                    this.reset();
                }
        
                if (this.lifeTime > 300) {  // Si ha pasado el tiempo, lo eliminamos
                    this.element.style.opacity = Math.max(1 - (this.lifeTime - 300) / 100, 0);  // Fade out
                }
            ...
            this.reset = function () {
                ...
                this.lifeTime = 0;  // Reseteamos el tiempo
                this.element.style.opacity = 1;  // Restauramos la opacidad
            };
        }
